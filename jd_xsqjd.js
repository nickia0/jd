...
23 7,16 * * * jd_xsqjd.js
https://raw.githubusercontent.com/star261/jd/main/scripts/jd_xsqjd.js
* */
const $ = new Env('限时抢京豆');
...
!(async () => {
    ...
    let res = [];
    try{res = await getAuthorShareCode('https://raw.githubusercontent.com/Argon-av/backup/main/code/shop.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://raw.githubusercontent.com/Argon-av/backup/main/code/shop.json');}catch (e) {}
        if(!res){res = [];}
    }
