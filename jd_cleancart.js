...
商品名称规则,默认所有账号全清空
——————CLEANCART_KEYWORDS————————
pin2@&@商品1,商品2                        ：该pin这几个商品名不清空 其余清空
pin5@&@                                   ：该pin全清
pin3@&@不清空                             ：该pin不清空
*@&@不清空                                ：所有账号不请空
pin2@&@商品1,商品2|-|pin5@&@商品3,商品4   ：pin2商品1，2 pin5商品3，4不清空 其余清空
*@&@                                      ：所有账号清空
*@&@净水器                                ：所有帐号除了 净水器 其余清空
...
cleancartProducts = $.isNode() ? (process.env.CLEANCART_KEYWORDS ? process.env.CLEANCART_KEYWORDS : '*@&@') : ($.getdata('CLEANCART_KEYWORDS') ? $.getdata('CLEANCART_KEYWORDS') : `${cleancartProducts}`);
