/*
1 5,17 * * * https://raw.githubusercontent.com/shufflewzc/faker2/main/jd_lzdz_unify.js
*/
const $ = new Env("骁龙");
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                '46fd2dbc40924c509115fe6301e7ad97',
            ]
            $.bean = 0;
...
async function unify() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            $.log("任务1")
            await task('unify/cardTaskDraw/doTask', `activityId=${$.activityId}&actorUuid=${encodeURIComponent($.actorUuid)}&param=null&taskType=20&pin=${encodeURIComponent($.secretPin)}&shareUuid=46fd2dbc40924c509115fe6301e7ad97}`)
            await $.wait(2000)
            $.log("任务1")
