...
!(async () => {
    ...
    let authorCode = []
    let res = await getAuthorShareCode('https://raw.githubusercontent.com/Argon-av/backup/main/code/tiger.json')
    if (!res) {
        res = await getAuthorShareCode('https://raw.fastgit.org/Argon-av/backup/main/code/tiger.json')
    }
    if (res) {
