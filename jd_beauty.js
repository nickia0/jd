...
function getIsvToken2() {
  let config = {
    ...
    headers: {
      'Host': 'api.m.jd.com',
      'accept': '*/*',
      'user-agent': `jdapp;iPhone;9.5.6;14.1;${$.UUID};network/wifi;ADID/${$.ADID};model/iPhone10,3;addressid/0;appBuild/167668;jdSupportDarkMode/0;Mozilla/5.0 (iPhone; CPU iPhone OS 13_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148;supportJDSHWK/1`,
